...
const transporter = nodemailer.createTransport({
  ...
  port: 587,
  auth: {
    user: 'nicholas.sanford@ethereal.email',
    pass: 'ScgU2TcjvBW2tHfGyz'
  }
});
...
router.post('/registerdata',function(req,res){
    var dob=[];
    data=req.body.nidno;    //data stores aadhar no
    console.log(data);
        ...
        conn.query(sql,record, function(err2,res2)
          {
             ...
             throw err2;
                ...
                var sql1="Update nid_info set Is_registered=? Where nidno=?";
